    ...
    <div>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          ...
          <span
            className={`badge ${
              incident.action_taken === "AUTO_REMEDIATED"
                ? "badge-remediated"
      ...
      >
        {/* Left: Chronicle Narrative + ES|QL */}
          ...
          <div className="glass-card" style={{ padding: "24px" }}>
            ...
            {factors.length > 0 && (
              <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                {factors.map(
                  (f: { label: string; score: number; weight: number }) => (
                    <div key={f.label}>
                      <div
                        style={{
                          display: "flex",
                      ...
                      >
                        <div
                          style={{
                            width: `${f.score}%`,
                            height: "100%",
                            background: confidenceHex(f.score),
                          }}
                        />
                      </div>
                    </div>
