    ...
    <div>
      ...
      <div className="glass-card" style={{ overflow: "hidden" }}>
        ...
        {rows.length === 0 ? (
          ...
          <div key={row.id} style={{ display: "grid", gridTemplateColumns: "1.5fr 2fr 1.5fr 1fr 1fr 0.5fr", gap: "16px", padding: "16px 24px", borderBottom: "1px solid var(--border)", alignItems: "center" }}>
            <div>
